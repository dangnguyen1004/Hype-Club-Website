...
def trade_spider(max_page):
    ...
    while page<= max_page :
        ...
        # for links in soup.find('div', {'class' : 'product-card css-1ikfoht css-z5nr6i css-11ziap1 css-zk7jxt css-dpr2cn product-grid__card '}):
        #     count_company += 1
        #     id = links.get('data-product-position')
        ...
        # if count_company==40:
        #     break
        links= soup.find('div', {'class' : 'product-card css-1ikfoht css-z5nr6i css-11ziap1 css-zk7jxt css-dpr2cn product-grid__card '})
        #print(soup)
        break 
        page +=1
